                        ...
                        order.length > 0 ? order.map(producto => {    
                            ...
                            <tr key={producto.product.id}>
                                ...
                                <th>
                                    ...
                                    <button className={s.sumarRestar} onClick={() => handleClickCart(producto.product, user)}>+</button></th>
                                <th>{producto.product.price * producto.cantidad}</th>
                                <th><button className={s.eliminarCarrito} onClick={()=>handleDeleteProduct(producto.product, user)}>Eliminar Producto</button></th>
